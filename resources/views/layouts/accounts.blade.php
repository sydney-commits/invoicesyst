...
<head>
    ...
    <link rel="icon" href="{{ asset('account/assets/images/favicon.ico') }}" type="image/x-icon">
			...
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						<img class="img-radius" src="{{ asset('account/assets/images/user/avatar-2.jpg')}}" alt="User-Profile-Image">
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Invoices</span></a>
						<ul class="pcoded-submenu">
							<li><a href="bc_alert.html">Active</a></li>
							<li><a href="bc_button.html">Settled</a></li>
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
				...
				<div class="m-header">
					...
					<a href="#!" class="b-brand">
						...
						<img src="{{ asset('account/assets/images/logo.png')}}" alt="" class="logo">
						<img src="{{ asset('account/assets/images/logo-icon.png')}}" alt="" class="logo-thumb">
					</a>
								...
								<div class="dropdown-menu dropdown-menu-right notification">
									...
									<ul class="noti-body">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="{{ asset('account/assets/images/user/avatar-1.jpg')}}" alt="Generic placeholder image">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="{{ asset('account/assets/images/user/avatar-2.jpg')}}" alt="Generic placeholder image">
												<div class="media-body">
						...
						<li>
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									<div class="pro-head">
										<img src="{{ asset('account/assets/images/user/avatar-1.jpg')}}" class="img-radius" alt="User-Profile-Image">
										<span>John Doe</span>
...
<div class="pcoded-main-container">
    ...
    <!-- Required Js -->
    <script src="{{ asset('account/assets/js/vendor-all.min.js')}}"></script>
    <script src="{{ asset('account/assets/js/plugins/bootstrap.min.js')}}"></script>
    <script src="{{ asset('account/assets/js/pcoded.min.js')}}"></script>

<!-- Apex Chart -->
<script src="{{ asset('account/assets/js/plugins/apexcharts.min.js')}}"></script>


<!-- custom-chart js -->
<script src="{{ asset('account/assets/js/pages/dashboard-main.js')}}"></script>
</body>
